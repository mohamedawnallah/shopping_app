...
List<ItemProductModel> itemProductModelFromJson(String str) => List<ItemProductModel>.from(json.decode(str).map((x) => ItemProductModel.fromJson(x,"0")));
...
String? intId;
  ...
  factory ItemProductModel.fromJson(Map<String, dynamic> json,String intId) => ItemProductModel(
    intId: intId,
...
class Media extends Equatable{
  ...
  List<Object?> get props => [mediaName,mediaType];
}
