...
class _ProfilePageState extends State<ProfilePage> {
                              ...
                              builder: (BuildContext context, shopProfile,
                                ...
                                return ListView(
                                  ...
                                  children: [
                                    ...
                                    buildName( shopProfile),
                                    const SizedBox(height: 24),
                                    Center(child: buildUpgradeButton()),
                                    const SizedBox(height: 24),
                                    NumbersWidget(),
                                    const SizedBox(height: 48),
                                    buildAbout( shopProfile),
                                  ],
                                );
                              },
                            ),
  ...
  Widget buildName(ShopProfileProvider shopProfileProvider) =>
      Column(
        children: [
          Text(
  ...
  Widget buildAbout( ShopProfileProvider shopProfile) => Container(
